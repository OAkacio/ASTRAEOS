...
#
# * ╭────────────────────────────────────────────────────────────────────────────╮
# * │   Classe Principal da Interface (AppWindow)                                │
# * ╰────────────────────────────────────────────────────────────────────────────╯
#
class AppWindow(ctk.CTk):
    ...
    #
    # * ╭────────────────────────────────────────────────────────────────────────────╮
    # * │   Rotinas de Interface Visual e Console                                    │
    # * ╰────────────────────────────────────────────────────────────────────────────╯
    #
    ...
    def _atualizar_ui_sim_exo_sucesso(self):
        ...
        try:
            ...
            figura_mag = plot_magnetosphere_shield(
                cte=i["cte"], Rplan=i["Rplan"], exoplanet_name=i["exoplanet_name"]
            )
    ...
    #
    # * ╭────────────────────────────────────────────────────────────────────────────╮
    # * │   Atualização de Gráficos e Componentes Visuais                            │
    # * ╰────────────────────────────────────────────────────────────────────────────╯
    #
    ...
    #
    # * ╭────────────────────────────────────────────────────────────────────────────╮
    # * │   Callbacks, Sinais de Threading e Tratamento de Erros                     │
    # * ╰────────────────────────────────────────────────────────────────────────────╯
    #
    # ? ╭────────────────────────────────────────────────────╮
    # ? │   Tratamento de Diagnóstico Físico                 │
    # ? ╰────────────────────────────────────────────────────╯
    #
    ...
    # ? ╭────────────────────────────────────────────────────╮
    # ? │   Respostas de Execução (Sucesso e Erro)           │
    # ? ╰────────────────────────────────────────────────────╯
    #
    ...
    def _atualizar_ui_erro(self, erro):
        ...
        if diagnostico:
            ...
            msg_console = f"\n\x1b[31m[!] PHYSICS INTEGRATION ERROR\x1b[0m\n► \x1b[37mPresentation:\x1b[0m {tipo}\n► \x1b[37mPhysics Meaning:\x1b[0m {significado}\n► \x1b[37mHow to fix:\x1b[0m {solucao}\n► \x1b[37mParameter to tweak:\x1b[0m \x1b[33m{parametro}\x1b[0m\n\n"
