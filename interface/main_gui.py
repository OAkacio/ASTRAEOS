...
class AppWindow(ctk.CTk):
    def __init__(self):
        ...
        # Proporções Verticais (Soma = 100)
        # Vá mudando esses números até achar o seu tamanho ideal!
        self.main_container.grid_rowconfigure(0, weight=85) # Gráfico ocupará 80% da altura
        self.main_container.grid_rowconfigure(1, weight=15) # Console ocupará 20% da altura
        
        # Proporções Horizontais: 70% esquerda, 30% direita
        ...
        # O pady=(0, 10) separa a base do gráfico do topo do console
        ...
        # Configuração das cores do terminal
        self.cores_ansi = {
            '30': '#282C34', '31': '#E06C75', '32': '#98C379', 
            '33': '#E5C07B', '34': '#61AFEF', '35': '#C678DD', 
            '36': '#56B6C2', '37': '#ABB2BF',                  
            '90': '#5C6370', '91': '#E06C75', '92': '#98C379', 
            '93': '#E5C07B', '94': '#61AFEF', '95': '#C678DD',
            '96': '#56B6C2', '97': '#FFFFFF'
        }
        ...
        # O rowspan=2 é o segredo para ocupar a altura inteira na direita!
    ...
    def executar_fisica(self):
        ...
        # Limpa o console próprio do main_gui
        self.console_box.configure(state="normal")
    ...
    def exibir_grafico(self, nome_arquivo="output.png"):
        ...
        if not os.path.exists(caminho_imagem):
            self.set_status(f"Erro: Arquivo {nome_arquivo} não encontrado na pasta figures.", "#E06C75")
            return
        ...
        try:
            ...
            if largura_painel < 10: largura_painel = 800
            if altura_painel < 10: altura_painel = 400 # Menor aqui por causa do console
    ...
    def ao_receber_log(self, texto_bruto):
        """Redireciona os prints do motor para a interface visual de forma segura"""
