...
# * Importações
# * ========================================================================================
# ? Carregamento dos módulos e dependências locais
# * ========================================================================================
try:
    from .lib import *
except ImportError:
...
# * Constantes Físicas
# * ========================================================================================
# ? Definição de constantes físicas e astronômicas fundamentais
# * ========================================================================================
...
# * ========================================================================================
# ? Coeficientes e limites de fluxo para bordas internas teóricas e empíricas
# * ========================================================================================

# ? --- Borda Interna (Recent Venus) --- [empirico/otimista: Fluxo de energia recebida por Vênus no momento que 'morreu']
Seff_sun_int_rv = 1.7763  # Fluxo solar efetivo [Lsol/AU²]
...
Seff_sun_int_rg = 1.0385  # Fluxo solar efetivo [Lsol/AU²]
...
Seff_sun_int_mg = 1.0146  # Fluxo solar efetivo [Lsol/AU²]
...
# * ========================================================================================
# ? Coeficientes e limites de fluxo para bordas externas teóricas e empíricas
# * ========================================================================================
...
Seff_sun_ext_mg = 0.3507  # Fluxo solar efetivo [Lsol/AU²]
...
Seff_sun_ext_em = 0.3207  # Fluxo solar efetivo [Lsol/AU²]
...
# * ========================================================================================
# ? Parâmetros de raio de segurança da magnetosfera planetária
# * ========================================================================================
