...
#
# * ╭────────────────────────────────────────────────────────────────────────────╮
# * │   Equação de Momento do Vento Estelar                                      │
# * ╰────────────────────────────────────────────────────────────────────────────╯
#
#
# ? ╭────────────────────────────────────────────────────╮
...
function derivada_velocidade_vento(x, y, vetor)
    ...
    numerador = (Z * y / x) * (vT^2 + razao_MA * deltav / 4.0 - 1.0 / (2.0 * Z * x)) + y * deltav / (2.0 * L)
...
#
# * ╭────────────────────────────────────────────────────────────────────────────╮
# * │   Análise de Singularidade e Pontos Críticos                               │
# * ╰────────────────────────────────────────────────────────────────────────────╯
#
#
# ? ╭────────────────────────────────────────────────────╮
